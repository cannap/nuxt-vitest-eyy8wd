import { reactive, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, toRef, isRef, h, isReadonly, mergeProps, useSSRContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
const components_plugin_FtpCgGLetN = /* @__PURE__ */ defineNuxtPlugin({
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-b07389eb.js").then((r) => r.default || r));
