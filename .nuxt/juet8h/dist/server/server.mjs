import { reactive, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, onBeforeUnmount, onDeactivated, onActivated, toRef, isRef, h, isReadonly, useSSRContext, mergeProps, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const components_plugin_DkHK5tFtdf = /* @__PURE__ */ defineNuxtPlugin({
...
const devRootDir = null;
const unhead_HMZT4BeNtb = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const router_XCAxD7h6YH = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const _plugins = [
  components_plugin_DkHK5tFtdf,
  unhead_HMZT4BeNtb,
  router_XCAxD7h6YH
];
const welcome_vue_vue_type_style_index_0_scoped_6ddc6d2b_lang = "";
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6ddc6d2b"], ["__file", "/home/projects/nuxt-vitest-eyy8wd/node_modules/.pnpm/@nuxt+ui-templates@1.1.1/node_modules/@nuxt/ui-templates/dist/templates/welcome.vue"]]);
const _sfc_main$1 = {};
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__file", "/home/projects/nuxt-vitest-eyy8wd/app.vue"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-cf442425.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-98b9b2e7.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
    const url = nuxtApp.ssrContext.url;
    const SingleRenderer = url.startsWith("/__nuxt_component_test__/") && /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/test-component-wrapper-36b6f3b4.js").then((r) => r.default(url)));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.4.3_@types+node@18.16.3/node_modules/nuxt/dist/app/components/nuxt-root.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "/home/projects/nuxt-vitest-eyy8wd/node_modules/.pnpm/nuxt@3.4.3_@types+node@18.16.3/node_modules/nuxt/dist/app/components/nuxt-root.vue"]]);
if (!globalThis.$fetch) {
